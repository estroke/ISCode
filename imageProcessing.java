...
public class imageProcessing {
    ...
    public void ContrastMethod(imageSegmentation newInstance, float scale) throws IOException {
        ...
        for (int i = 0; i < newInstance.region.size(); i++) {
            //accessing each x and y value from the region list of arrays[x,y]
                ...
                int pixel = newInstance.image.getRGB(x, y);
                    ...
                    newInstance.image.setRGB(x,y,rgb);
        }
    }
    public void GreyScaleMethod(imageSegmentation newInstance) throws IOException {
            ...
            //accessing each x and y value from the region list of arrays[x,y]
                ...
                int y = array[1];
                    ...
                    newInstance.image.setRGB(x, y, pixel);
    ...
    public void Brightness(imageSegmentation newInstance) throws IOException {

        //yellow testing color
        ...
        //printing test
        // for(int[] element : newInstance.region) {
    ...
    public void MedianMethod(File file) throws IOException {
